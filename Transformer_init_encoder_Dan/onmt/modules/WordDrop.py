...
def switchout(words, vocab_size, tau=1.0, transpose=False, offset=0):
    ...
    #print(torch.eq(words, onmt.Constants.BERT_MASK))
    mask = torch.eq(words, onmt.Constants.BOS) | torch.eq(words, onmt.Constants.EOS) \
       | torch.eq(words, onmt.Constants.PAD)    
